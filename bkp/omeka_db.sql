...
(65, 5, 4, 'UUID', '', ''),
(66, 7, 1, 'ID', 'O ID a ser aplicado a um Trabalho, Imagem ou Coleção do VRA (corresponde ao atributo de ID do vra).', ''),
(67, 7, 2, 'Título', 'Titulo ou frase de identificação dada a uma Obra ou Imagem.', ''),
(68, 7, 3, 'Agente', 'Os nomes, apelações ou outros identificadores atribuídos a um indivíduo, grupo ou órgão corporativo que contribuíram para o design, criação, produção, fabricação ou alteração da obra ou imagem.', ''),
(69, 7, 4, 'Contexto Cultural', 'O nome da cultura, pessoas (etnônimo) ou forma adjetiva de um nome de país do qual uma Obra, Coleção ou Imagem se origina, ou o contexto cultural ao qual a Obra, Coleção ou Imagem foi associada.', ''),
(70, 7, 5, 'Data da Criação', 'Data ou intervalo de datas associadas à criação, design, produção, apresentação, desempenho, construção ou alteração, etc. da obra ou imagem. As datas podem ser expressas como texto livre ou numérico. No formato aaaa-mm-dd aaaa-mm-dd.', ''),
(71, 7, 6, 'Descrição', 'Uma nota de texto livre sobre a Obra, Coleção ou Imagem, incluindo comentários, descrição ou interpretação, que fornece informações adicionais não registradas em outras categorias.', ''),
(72, 7, 7, 'Inscrição', 'Todas as marcas ou palavras escritas adicionadas ao objeto no momento da produção ou em sua história subsequente, incluindo assinaturas, datas, dedicatórias, textos e colofones, além de marcas, como carimbos de ourives, editores ou impressoras.', ''),
(73, 7, 8, 'Localização', 'A localização geográfica e / ou nome do repositório, edifício, local ou outra entidade cujos limites incluem Trabalho ou Imagem.', ''),
(74, 7, 9, 'Material', 'A substância da qual um trabalho ou uma imagem é composta.', ''),
(75, 7, 10, 'Medidas', 'O tamanho físico, forma, escala, dimensões ou formato da Obra ou Imagem. As dimensões podem incluir medidas como volume, peso, área ou tempo de execução.', ''),
(76, 7, 11, 'Relação', 'Termos ou frases que descrevem a identidade do trabalho relacionado e o relacionamento entre o trabalho que está sendo catalogado e o trabalho ou imagem relacionado.', ''),
(77, 7, 12, 'Direitos', 'Informações sobre o status dos direitos autorais e o detentor dos direitos de uma obra, coleção ou imagem', ''),
(78, 7, 13, 'Fonte', 'Uma referência à fonte das informações registradas sobre o trabalho ou a imagem.', ''),
(79, 7, 14, 'Edição', 'O número de identificação e / ou nome atribuído ao estado ou edição de uma obra que existe em mais de uma forma e a colocação dessa obra no contexto de emissões anteriores ou posteriores de múltiplos da mesma obra.', ''),
(80, 7, 15, 'Estilo ou Período', 'Um estilo definido, período histórico, grupo, escola, dinastia, movimento etc. cujas características estão representadas na Obra ou na Imagem.', ''),
(81, 7, 16, 'Subject', 'Termos ou frases que descrevem, identificam ou interpretam a Obra ou Imagem e o que ela representa ou expressa. Eles podem incluir termos genéricos que descrevem o trabalho e os elementos que ele compreende, termos que identificam pessoas específicas, locais geográficos, temas narrativos e iconográficos ou termos que se referem a conceitos ou interpretações mais amplos.', ''),
(82, 7, 17, 'Técnica', 'Os processos, técnicas e métodos de produção ou fabricação incorporados na fabricação ou alteração da obra ou imagem.', ''),
(83, 7, 18, 'Textref', 'Contém o nome de uma referência textual relacionada e qualquer tipo de identificador exclusivo que o texto atribui a uma Obra ou Coleção que é independente de qualquer repositório.', ''),
(84, 7, 19, 'Tipo de Trabalho', 'Identifica o tipo específico de Trabalho, Coleção ou Imagem que está sendo descrito no registro.', ''),
...
(4, 3, 'Collection', 'private_manifest', '{\"@context\":\"http://www.shared-canvas.org/ns/context.json\",\"@id\":\"http://172.16.8.55/oa/collections/3/manifest.json\",\"@type\":\"sc:Manifest\",\"label\":\"At\\u00edlio Avancini\",\"sequences\":[{\"@id\":\"http://172.16.8.55/oa/collections/3/sequence.json\",\"@type\":\"sc:Sequence\",\"label\":\"\",\"canvases\":[{\"@id\":\"http://172.16.8.55/oa/items/129/canvas.json\",\"label\":\"Lavagem do Bonfim: formas de reportar [s\\u00e9rie]\",\"@type\":\"sc:Canvas\",\"width\":6220,\"height\":3902,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/71/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/8c827506aa38054238afe2ca4eb271a1.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":6220,\"height\":3902,\"service\":{\"@id\":\"http://172.16.8.55:5004/8c827506aa38054238afe2ca4eb271a1.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/129/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"At\\u00edlio Avancini\"},{\"label\":\"Identifier\",\"value\":\"003\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/129/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/141/canvas.json\",\"label\":\"Alma baiana 1\",\"@type\":\"sc:Canvas\",\"width\":4251,\"height\":2818,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/22/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/850d17c910a1591014725cb8a5dd994c.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":4251,\"height\":2818,\"service\":{\"@id\":\"http://172.16.8.55:5004/850d17c910a1591014725cb8a5dd994c.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/141/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"8718\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/141/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/142/canvas.json\",\"label\":\"Alma baiana 2\",\"@type\":\"sc:Canvas\",\"width\":4257,\"height\":2821,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/21/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/0ac31096dc327b9eaa7bcc8fb37c11ef.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":4257,\"height\":2821,\"service\":{\"@id\":\"http://172.16.8.55:5004/0ac31096dc327b9eaa7bcc8fb37c11ef.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/142/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"8719\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/142/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/143/canvas.json\",\"label\":\"Alma baiana 3\",\"@type\":\"sc:Canvas\",\"width\":4263,\"height\":2817,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/20/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/ff167a6dfa058d1bba80360ce9d3aa33.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":4263,\"height\":2817,\"service\":{\"@id\":\"http://172.16.8.55:5004/ff167a6dfa058d1bba80360ce9d3aa33.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/143/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"8720\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/143/annolist.json\",\"@type\":\"sc:AnnotationList\"}]}]}]}', '2019-12-10 16:21:59'),
(5, 2, 'Collection', 'private_manifest', '{\"@context\":\"http://www.shared-canvas.org/ns/context.json\",\"@id\":\"http://172.16.8.55/oa/collections/2/manifest.json\",\"@type\":\"sc:Manifest\",\"label\":\"Geraldo Souza Dias\",\"sequences\":[{\"@id\":\"http://172.16.8.55/oa/collections/2/sequence.json\",\"@type\":\"sc:Sequence\",\"label\":\"\",\"canvases\":[{\"@id\":\"http://172.16.8.55/oa/items/131/canvas.json\",\"label\":\"Torre de Babel na Pinacoteca, vista geral\",\"@type\":\"sc:Canvas\",\"width\":562,\"height\":794,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/25/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/b1f09bc0755e9f31a164bee9ad3d836a.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":562,\"height\":794,\"service\":{\"@id\":\"http://172.16.8.55:5004/b1f09bc0755e9f31a164bee9ad3d836a.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/131/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"8721\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/131/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/134/canvas.json\",\"label\":\"Torre de Babel na Pinacoteca, detalhes [1]\",\"@type\":\"sc:Canvas\",\"width\":794,\"height\":562,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/23/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/7fc5c61083b4d6813f4dced4de2b897b.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":794,\"height\":562,\"service\":{\"@id\":\"http://172.16.8.55:5004/7fc5c61083b4d6813f4dced4de2b897b.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items
\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/75/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/1e95279271ed43e9e7aed4aa57184ed7.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":1200,\"height\":1600,\"service\":{\"@id\":\"http://172.16.8.55:5004/1e95279271ed43e9e7aed4aa57184ed7.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/172/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"Geraldo de Souza Dias Filho\"},{\"label\":\"Identifier\",\"value\":\"8743\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/172/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/173/canvas.json\",\"label\":\"Exposi\\u00e7\\u00e3o A desobedi\\u00eancia civil\",\"@type\":\"sc:Canvas\",\"width\":3984,\"height\":2241,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/70/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/08f4b28072c6aa868a2529bbf6a096a6.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":3984,\"height\":2241,\"service\":{\"@id\":\"http://172.16.8.55:5004/08f4b28072c6aa868a2529bbf6a096a6.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/173/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"007\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/173/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/177/canvas.json\",\"label\":\"Musas\",\"@type\":\"sc:Canvas\",\"width\":5184,\"height\":3888,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/72/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/5e876587b3c0939aef97ad42c1a42130.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":5184,\"height\":3888,\"service\":{\"@id\":\"http://172.16.8.55:5004/5e876587b3c0939aef97ad42c1a42130.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/177/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"Geraldo de Souza Dias Filho\"},{\"label\":\"Identifier\",\"value\":\"085\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/177/annolist.json\",\"@type\":\"sc:AnnotationList\"}]}]}]}', '2019-12-10 16:45:34'),
(6, 3, 'Collection', 'public_manifest', '{\"@context\":\"http://www.shared-canvas.org/ns/context.json\",\"@id\":\"http://172.16.8.55/oa/collections/3/manifest.json\",\"@type\":\"sc:Manifest\",\"label\":\"At\\u00edlio Avancini\",\"sequences\":[{\"@id\":\"http://172.16.8.55/oa/collections/3/sequence.json\",\"@type\":\"sc:Sequence\",\"label\":\"\",\"canvases\":[{\"@id\":\"http://172.16.8.55/oa/items/129/canvas.json\",\"label\":\"Lavagem do Bonfim: formas de reportar [s\\u00e9rie]\",\"@type\":\"sc:Canvas\",\"width\":6220,\"height\":3902,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/71/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/8c827506aa38054238afe2ca4eb271a1.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":6220,\"height\":3902,\"service\":{\"@id\":\"http://172.16.8.55:5004/8c827506aa38054238afe2ca4eb271a1.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/129/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"At\\u00edlio Avancini\"},{\"label\":\"Identifier\",\"value\":\"003\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/129/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/141/canvas.json\",\"label\":\"Alma baiana 1\",\"@type\":\"sc:Canvas\",\"width\":4251,\"height\":2818,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/22/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/850d17c910a1591014725cb8a5dd994c.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":4251,\"height\":2818,\"service\":{\"@id\":\"http://172.16.8.55:5004/850d17c910a1591014725cb8a5dd994c.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/141/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"8718\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/141/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/142/canvas.json\",\"label\":\"Alma baiana 2\",\"@type\":\"sc:Canvas\",\"width\":4257,\"height\":2821,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/21/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/0ac31096dc327b9eaa7bcc8fb37c11ef.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":4257,\"height\":2821,\"service\":{\"@id\":\"http://172.16.8.55:5004/0ac31096dc327b9eaa7bcc8fb37c11ef.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/142/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"8719\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/142/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/143/canvas.json\",\"label\":\"Alma baiana 3\",\"@type\":\"sc:Canvas\",\"width\":4263,\"height\":2817,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/20/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/ff167a6dfa058d1bba80360ce9d3aa33.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":4263,\"height\":2817,\"service\":{\"@id\":\"http://172.16.8.55:5004/ff167a6dfa058d1bba80360ce9d3aa33.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/143/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"8720\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items
JPG\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":1600,\"height\":1200,\"service\":{\"@id\":\"http://172.16.8.55:5004/5308836a1e8538fc51c9b383c535f341.JPG\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/169/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"Geraldo de Souza Dias Filho\"},{\"label\":\"Identifier\",\"value\":\"8740\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/169/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/170/canvas.json\",\"label\":\"Torre de Babel na FAU, detalhe interno\",\"@type\":\"sc:Canvas\",\"width\":1600,\"height\":1200,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/32/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/78b30ef2f5378095cf7011059b56c1d8.JPG\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":1600,\"height\":1200,\"service\":{\"@id\":\"http://172.16.8.55:5004/78b30ef2f5378095cf7011059b56c1d8.JPG\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/170/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"Geraldo de Souza Dias Filho\"},{\"label\":\"Identifier\",\"value\":\"8741\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/170/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/171/canvas.json\",\"label\":\"Torre de Babel na FAU, montagem\",\"@type\":\"sc:Canvas\",\"width\":1600,\"height\":1200,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/31/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/c83435c10a7fe700f376788bc6d6db50.JPG\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":1600,\"height\":1200,\"service\":{\"@id\":\"http://172.16.8.55:5004/c83435c10a7fe700f376788bc6d6db50.JPG\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/171/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"Geraldo de Souza Dias Filho\"},{\"label\":\"Identifier\",\"value\":\"8742\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/171/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/172/canvas.json\",\"label\":\"Torre de Babel na FAU, montagem\",\"@type\":\"sc:Canvas\",\"width\":1200,\"height\":1600,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/75/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/1e95279271ed43e9e7aed4aa57184ed7.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":1200,\"height\":1600,\"service\":{\"@id\":\"http://172.16.8.55:5004/1e95279271ed43e9e7aed4aa57184ed7.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/172/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"Geraldo de Souza Dias Filho\"},{\"label\":\"Identifier\",\"value\":\"8743\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/172/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/173/canvas.json\",\"label\":\"Exposi\\u00e7\\u00e3o A desobedi\\u00eancia civil\",\"@type\":\"sc:Canvas\",\"width\":3984,\"height\":2241,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/70/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/08f4b28072c6aa868a2529bbf6a096a6.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":3984,\"height\":2241,\"service\":{\"@id\":\"http://172.16.8.55:5004/08f4b28072c6aa868a2529bbf6a096a6.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/173/canvas.json\"}],\"metadata\":[{\"label\":\"Identifier\",\"value\":\"007\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/173/annolist.json\",\"@type\":\"sc:AnnotationList\"}]},{\"@id\":\"http://172.16.8.55/oa/items/177/canvas.json\",\"label\":\"Musas\",\"@type\":\"sc:Canvas\",\"width\":5184,\"height\":3888,\"images\":[{\"@id\":\"http://172.16.8.55/oa/files/72/anno.json\",\"motivation\":\"sc:painting\",\"@type\":\"oa:Annotation\",\"resource\":{\"@id\":\"http://172.16.8.55/files/original/5e876587b3c0939aef97ad42c1a42130.jpg\",\"@type\":\"dctypes:Image\",\"format\":\"image/jpeg\",\"width\":5184,\"height\":3888,\"service\":{\"@id\":\"http://172.16.8.55:5004/5e876587b3c0939aef97ad42c1a42130.jpg\",\"@context\":\"http://iiif.io/api/image/2/context.json\",\"profile\":\"http://iiif.io/api/image/2/level2.json\"}},\"on\":\"http://172.16.8.55/oa/items/177/canvas.json\"}],\"metadata\":[{\"label\":\"Creator\",\"value\":\"Geraldo de Souza Dias Filho\"},{\"label\":\"Identifier\",\"value\":\"085\"}],\"otherContent\":[{\"@id\":\"http://172.16.8.55/oa/items/177/annolist.json\",\"@type\":\"sc:AnnotationList\"}]}]}]}', '2019-12-12 16:08:00');
...
--
-- Table structure for table `omeka_import_importers`
--
...
--
-- Dumping data for table `omeka_import_importers`
--
...
--
-- Table structure for table `omeka_import_imports`
--
...
--
-- Dumping data for table `omeka_import_imports`
--
...
--
-- Table structure for table `omeka_import_logs`
--
...
--
-- Dumping data for table `omeka_import_logs`
--
...
--
-- Table structure for table `omeka_item_duplicate_check_rules`
--
...
--
-- Table structure for table `omeka_item_relations_properties`
--
...
--
-- Dumping data for table `omeka_item_relations_properties`
--
...
--
-- Table structure for table `omeka_item_relations_relations`
--
...
--
-- Table structure for table `omeka_item_relations_vocabularies`
--
...
--
-- Dumping data for table `omeka_item_relations_vocabularies`
--
...
(747, 'theme_eca1_options', 'a:30:{s:7:\"favicon\";N;s:11:\"footer_text\";N;s:24:\"display_footer_copyright\";N;s:19:\"use_advanced_search\";s:1:\"0\";s:29:\"homepage_introduction_content\";N;s:45:\"homepage_jumbotron_section_1_background_image\";N;s:39:\"homepage_jumbotron_section_1_title_icon\";N;s:36:\"homepage_jumbotron_section_1_title_1\";N;s:36:\"homepage_jumbotron_section_1_title_2\";N;s:33:\"homepage_jumbotron_section_1_info\";N;s:33:\"homepage_jumbotron_section_1_link\";N;s:45:\"homepage_jumbotron_section_2_background_image\";N;s:39:\"homepage_jumbotron_section_2_title_icon\";N;s:36:\"homepage_jumbotron_section_2_title_1\";N;s:36:\"homepage_jumbotron_section_2_title_2\";N;s:33:\"homepage_jumbotron_section_2_info\";N;s:33:\"homepage_jumbotron_section_2_link\";N;s:45:\"homepage_jumbotron_section_3_background_image\";N;s:39:\"homepage_jumbotron_section_3_title_icon\";N;s:36:\"homepage_jumbotron_section_3_title_1\";N;s:36:\"homepage_jumbotron_section_3_title_2\";N;s:33:\"homepage_jumbotron_section_3_info\";N;s:33:\"homepage_jumbotron_section_3_link\";N;s:45:\"homepage_jumbotron_section_4_background_image\";N;s:39:\"homepage_jumbotron_section_4_title_icon\";N;s:36:\"homepage_jumbotron_section_4_title_1\";N;s:36:\"homepage_jumbotron_section_4_title_2\";N;s:33:\"homepage_jumbotron_section_4_info\";N;s:33:\"homepage_jumbotron_section_4_link\";N;s:17:\"theme_config_csrf\";N;}'),
(750, 'public_theme', 'denison'),
(751, 'theme_denison_options', 'a:30:{s:7:\"favicon\";N;s:11:\"footer_text\";N;s:24:\"display_footer_copyright\";N;s:19:\"use_advanced_search\";s:1:\"0\";s:29:\"homepage_introduction_content\";N;s:45:\"homepage_jumbotron_section_1_background_image\";N;s:39:\"homepage_jumbotron_section_1_title_icon\";N;s:36:\"homepage_jumbotron_section_1_title_1\";N;s:36:\"homepage_jumbotron_section_1_title_2\";N;s:33:\"homepage_jumbotron_section_1_info\";N;s:33:\"homepage_jumbotron_section_1_link\";N;s:45:\"homepage_jumbotron_section_2_background_image\";N;s:39:\"homepage_jumbotron_section_2_title_icon\";N;s:36:\"homepage_jumbotron_section_2_title_1\";N;s:36:\"homepage_jumbotron_section_2_title_2\";N;s:33:\"homepage_jumbotron_section_2_info\";N;s:33:\"homepage_jumbotron_section_2_link\";N;s:45:\"homepage_jumbotron_section_3_background_image\";N;s:39:\"homepage_jumbotron_section_3_title_icon\";N;s:36:\"homepage_jumbotron_section_3_title_1\";N;s:36:\"homepage_jumbotron_section_3_title_2\";N;s:33:\"homepage_jumbotron_section_3_info\";N;s:33:\"homepage_jumbotron_section_3_link\";N;s:45:\"homepage_jumbotron_section_4_background_image\";N;s:39:\"homepage_jumbotron_section_4_title_icon\";N;s:36:\"homepage_jumbotron_section_4_title_1\";N;s:36:\"homepage_jumbotron_section_4_title_2\";N;s:33:\"homepage_jumbotron_section_4_info\";N;s:33:\"homepage_jumbotron_section_4_link\";N;s:17:\"theme_config_csrf\";N;}'),
(755, 'public_navigation_main', '[{\"uid\":\"http:\\/\\/172.16.8.55\\/\",\"can_delete\":true,\"type\":\"Omeka_Navigation_Page_Uri\",\"label\":\"In\\u00edcio\",\"fragment\":null,\"id\":null,\"class\":null,\"title\":null,\"target\":null,\"accesskey\":null,\"rel\":[],\"rev\":[],\"customHtmlAttribs\":[],\"order\":1,\"resource\":null,\"privilege\":null,\"active\":false,\"visible\":true,\"pages\":[],\"uri\":\"http:\\/\\/172.16.8.55\\/\"},{\"uid\":\"\\/items\\/browse\",\"can_delete\":false,\"type\":\"Omeka_Navigation_Page_Uri\",\"label\":\"Ver Itens\",\"fragment\":null,\"id\":null,\"class\":null,\"title\":null,\"target\":null,\"accesskey\":null,\"rel\":[],\"rev\":[],\"customHtmlAttribs\":[],\"order\":2,\"resource\":null,\"privilege\":null,\"active\":false,\"visible\":true,\"pages\":[],\"uri\":\"\\/items\\/browse\"},{\"uid\":\"\\/collections\\/browse\",\"can_delete\":false,\"type\":\"Omeka_Navigation_Page_Uri\",\"label\":\"Ver as Cole\\u00e7\\u00f5es\",\"fragment\":null,\"id\":null,\"class\":null,\"title\":null,\"target\":null,\"accesskey\":null,\"rel\":[],\"rev\":[],\"customHtmlAttribs\":[],\"order\":3,\"resource\":null,\"privilege\":null,\"active\":false,\"visible\":true,\"pages\":[],\"uri\":\"\\/collections\\/browse\"},{\"uid\":\"\\/iiif-items\\/tree\",\"can_delete\":false,\"type\":\"Omeka_Navigation_Page_Uri\",\"label\":\"Navegar pelo cat\\u00e1logo\",\"fragment\":null,\"id\":null,\"class\":null,\"title\":null,\"target\":null,\"accesskey\":null,\"rel\":[],\"rev\":[],\"customHtmlAttribs\":[],\"order\":4,\"resource\":null,\"privilege\":null,\"active\":false,\"visible\":false,\"pages\":[],\"uri\":\"\\/iiif-items\\/tree\"},{\"uid\":\"\\/exhibits\",\"can_delete\":false,\"type\":\"Omeka_Navigation_Page_Uri\",\"label\":\"Ver Exposi\\u00e7\\u00f5es\",\"fragment\":null,\"id\":null,\"class\":null,\"title\":null,\"target\":null,\"accesskey\":null,\"rel\":[],\"rev\":[],\"customHtmlAttribs\":[],\"order\":5,\"resource\":null,\"privilege\":null,\"active\":false,\"visible\":true,\"pages\":[],\"uri\":\"\\/exhibits\"},{\"uid\":\"\\/sobre\",\"can_delete\":false,\"type\":\"Omeka_Navigation_Page_Uri\",\"label\":\"Sobre\",\"fragment\":null,\"id\":null,\"class\":null,\"title\":null,\"target\":null,\"accesskey\":null,\"rel\":[],\"rev\":[],\"customHtmlAttribs\":[],\"order\":6,\"resource\":null,\"privilege\":null,\"active\":false,\"visible\":false,\"pages\":[],\"uri\":\"\\/sobre\"}]'),
(756, 'homepage_uri', '/'),
(758, 'omeka_update', 'a:2:{s:14:\"latest_version\";s:4:\"2.7\n\";s:12:\"last_updated\";i:1576498652;}');
...
(138, 'Omeka_Job_Process_Wrapper', 2, NULL, 'completed', 'a:1:{s:3:\"job\";s:164:\"{\"className\":\"DerivativeImagesJob\",\"options\":{\"process_type\":\"all\",\"derivative_types\":null,\"mime_types\":null},\"createdAt\":\"2019-12-10T16:18:59+00:00\",\"createdBy\":2}\";}', '2019-12-10 18:19:00', '2019-12-10 18:19:23');
...
--
-- Table structure for table `omeka_relationships`
--
...
--
-- Dumping data for table `omeka_relationships`
--
...
--
-- Table structure for table `omeka_relationship_images`
--
...
--
-- Table structure for table `omeka_relationship_rules`
--
...
--
-- Dumping data for table `omeka_relationship_rules`
--
...
--
-- Table structure for table `omeka_relationship_types`
--
...
--
-- Dumping data for table `omeka_relationship_types`
--
...
('01d73db943b80c873a061c924fd02641', 1576168444, 1209600, ),
('02b241b2eaa5f635300f5f61b9d7cb30', 1576178758, 1209600, ),
('04d076432cfbda3918cc7f81cf8101f3', 1576507321, 1209600, ''),
...
('1b2a455bc1e62c036c9a7cb7a83e5673', 1576254710, 1209600, ),
...
('26c7aa9a13fedb41e26105408ee9f840', 1576507321, 1209600, ''),
('26f65ec829a339a49feeaa2ec41a3671', 1576507323, 1209600, ),
...
('469309835de777e75ed8475777d4c6fb', 1575998327, 1209600, ''),
...
('5bf78a0bdca3407c5dda8820d823bed1', 1576507322, 1209600, ''),
('644dbe91e8da4320d84f86d709d7be84', 1575997124, 1209600, ),
('64d57bce494bae640b7ad8a69ff3ccc6', 1576512606, 1209600, ''),
...
('ae52b96a9b6710aa72d1e1fc3d7a952a', 1576003996, 1209600, ''),
('b34ec136a06b1b61a1e00cb287ee9608', 1575493554, 1209600, ''),
('b69ad39e63bb82bf0f046b7fb449f020', 1575994763, 1209600, ''),
('b773248298690307a0e2ecde59b48d40', 1576005974, 1209600, ''),
...
('d7e72917118e8730823f7c1d451975a4', 1576513368, 1209600, ),
...
('eed308f86f777e7d9a4e870bf78a302c', 1576507322, 1209600, ''),
('f1490809246930c07c273bc8c0cf225a', 1575494012, 1209600, ''),
('f6af66e18477db6d43d18e541606866e', 1576167890, 1209600, ''),
...
--
-- Table structure for table `omeka_user_profiles_multi_elements`
--
...
--
-- Table structure for table `omeka_user_profiles_multi_values`
--
...
--
-- Table structure for table `omeka_user_profiles_profiles`
--
...
--
-- Table structure for table `omeka_user_profiles_types`
--
...
--
-- Table structure for table `omeka_vra_core_attributes`
--
...
--
-- Dumping data for table `omeka_vra_core_attributes`
--
...
--
-- Table structure for table `omeka_vra_core_elements`
--
...
--
-- Dumping data for table `omeka_vra_core_elements`
--
...
--
-- Indexes for table `omeka_admin_images`
--
...
--
-- Indexes for table `omeka_csv_import_imported_items`
--
...
--
-- Indexes for table `omeka_csv_import_imports`
--
...
--
-- Indexes for table `omeka_import_importers`
--
ALTER TABLE `omeka_import_importers`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_import_imports`
--
...
--
-- Indexes for table `omeka_import_logs`
--
...
--
-- Indexes for table `omeka_item_duplicate_check_rules`
--
...
--
-- Indexes for table `omeka_item_relations_properties`
--
ALTER TABLE `omeka_item_relations_properties`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_item_relations_relations`
--
ALTER TABLE `omeka_item_relations_relations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_item_relations_vocabularies`
--
...
--
-- Indexes for table `omeka_record_relations_properties`
--
ALTER TABLE `omeka_record_relations_properties`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_record_relations_relations`
--
ALTER TABLE `omeka_record_relations_relations`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_record_relations_vocabularies`
--
ALTER TABLE `omeka_record_relations_vocabularies`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_relationships`
--
ALTER TABLE `omeka_relationships`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_relationship_images`
--
ALTER TABLE `omeka_relationship_images`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_relationship_rules`
--
ALTER TABLE `omeka_relationship_rules`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_relationship_types`
--
...
--
-- Indexes for table `omeka_simple_vocab_terms`
--
...
--
-- Indexes for table `omeka_user_profiles_multi_elements`
--
ALTER TABLE `omeka_user_profiles_multi_elements`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_user_profiles_multi_values`
--
ALTER TABLE `omeka_user_profiles_multi_values`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_user_profiles_profiles`
--
ALTER TABLE `omeka_user_profiles_profiles`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_user_profiles_types`
--
ALTER TABLE `omeka_user_profiles_types`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_vra_core_attributes`
--
ALTER TABLE `omeka_vra_core_attributes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `omeka_vra_core_elements`
--
...
--
-- AUTO_INCREMENT for table `omeka_admin_images`
--
ALTER TABLE `omeka_admin_images`
...
--
-- AUTO_INCREMENT for table `omeka_csv_import_imported_items`
--
ALTER TABLE `omeka_csv_import_imported_items`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `omeka_csv_import_imports`
--
ALTER TABLE `omeka_csv_import_imports`
...
--
-- AUTO_INCREMENT for table `omeka_import_importers`
--
ALTER TABLE `omeka_import_importers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `omeka_import_imports`
--
ALTER TABLE `omeka_import_imports`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `omeka_import_logs`
--
ALTER TABLE `omeka_import_logs`
...
--
-- AUTO_INCREMENT for table `omeka_item_duplicate_check_rules`
--
ALTER TABLE `omeka_item_duplicate_check_rules`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `omeka_item_relations_properties`
--
ALTER TABLE `omeka_item_relations_properties`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;

--
-- AUTO_INCREMENT for table `omeka_item_relations_relations`
--
ALTER TABLE `omeka_item_relations_relations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `omeka_item_relations_vocabularies`
--
ALTER TABLE `omeka_item_relations_vocabularies`
...
--
-- AUTO_INCREMENT for table `omeka_record_relations_properties`
--
ALTER TABLE `omeka_record_relations_properties`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;

--
-- AUTO_INCREMENT for table `omeka_record_relations_relations`
--
ALTER TABLE `omeka_record_relations_relations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `omeka_record_relations_vocabularies`
--
ALTER TABLE `omeka_record_relations_vocabularies`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `omeka_relationships`
--
ALTER TABLE `omeka_relationships`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT for table `omeka_relationship_images`
--
ALTER TABLE `omeka_relationship_images`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `omeka_relationship_rules`
--
ALTER TABLE `omeka_relationship_rules`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `omeka_relationship_types`
--
ALTER TABLE `omeka_relationship_types`
...
--
-- AUTO_INCREMENT for table `omeka_simple_vocab_terms`
--
ALTER TABLE `omeka_simple_vocab_terms`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `omeka_user_profiles_multi_elements`
--
ALTER TABLE `omeka_user_profiles_multi_elements`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `omeka_user_profiles_multi_values`
--
ALTER TABLE `omeka_user_profiles_multi_values`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `omeka_user_profiles_profiles`
--
ALTER TABLE `omeka_user_profiles_profiles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `omeka_user_profiles_types`
--
ALTER TABLE `omeka_user_profiles_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `omeka_vra_core_attributes`
--
ALTER TABLE `omeka_vra_core_attributes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT for table `omeka_vra_core_elements`
--
ALTER TABLE `omeka_vra_core_elements`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
-- Constraints for table `omeka_item_duplicate_check_rules`
--
ALTER TABLE `omeka_item_duplicate_check_rules`
