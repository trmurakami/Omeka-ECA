...
<html>
	<head>
		<title>Biblioteca Digital da Produção Artística da ECA/USP</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no" />
		<link rel="stylesheet" href="themes/denison/assets/css/main.css" />
		<!--[if lte IE 9]><link rel="stylesheet" href="assets/css/ie9.css" /><![endif]-->
		<noscript><link rel="stylesheet" href="themes/denison/assets/css/noscript.css" /></noscript>
	</head>
	<body>
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header">
						<div class="content">
							<div class="inner">
								<h1>Biblioteca Digital da Produção Artística da ECA/USP</h1>
							</div>
						</div>
						<nav>
							<ul>
				...
				<!-- Main -->
					<div id="main">
						...
						<article id="about">
							...
							<!-- <span class="image main"><img src="themes/denison/images/pic01.jpg" alt="" /></span> -->
				...
				<!-- Footer -->
					<footer id="footer">
						<p>Universidade de São Paulo - Escola de Comunicações e Artes</b>
		...
		<!-- Scripts -->
			<script src="themes/denison/assets/js/jquery.min.js"></script>
			<script src="themes/denison/assets/js/skel.min.js"></script>
			<script src="themes/denison/assets/js/util.js"></script>
			<script src="themes/denison/assets/js/main.js"></script>
